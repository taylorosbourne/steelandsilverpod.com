...
const IndexContainer: FC<Props> = ({episodes}) => (
  <Container>
    <div style={{margin: `15px 0`, display: `flex`, flexDirection: `column`, alignItems: `flex-start`}}>
      ...
      <div style={{width: `100%`}}>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://www.patreon.com/steelandsilverpod"><PatreonImage src={Patreon} alt="patreon" /></a>
      </div>
    </div>
    <div>
